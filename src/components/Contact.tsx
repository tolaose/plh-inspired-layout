...
const Contact = () => {
  ...
  const ZAPIER_WEBHOOK_URL = "https://webhook.site/13f2152c-129f-47bc-bd47-3eac8ded1b00";

  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    
    if (ZAPIER_WEBHOOK_URL === "https://webhook.site/13f2152c-129f-47bc-bd47-3eac8ded1b00") {
      toast({
